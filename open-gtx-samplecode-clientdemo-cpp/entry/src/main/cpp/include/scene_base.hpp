...
public:
    ...
    [[nodiscard]] virtual bool OnSwitchMode(int index) noexcept = 0;
    [[nodiscard]] virtual bool OnSwitchTargetFPS(int index) noexcept = 0;
    [[nodiscard]] virtual bool OnSwitchSceneID(int index) noexcept = 0;
...
protected:
    ...
    OpenGTX_Context *contextGtx_ = nullptr;
