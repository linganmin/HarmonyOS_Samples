...
#define OPENGTX_BIND(slot, count, field)                                                                              \
    ...
    OPENGTX_BIND(VERTICES, 3, vertex_);
    OPENGTX_BIND(UVS, 2, uv_);
    OPENGTX_BIND(NORMALS, 3, normal_);
    OPENGTX_BIND(TANGENTS, 3, tangent_);
    OPENGTX_BIND(BITANGENTS, 3, bitangent_);
