 ...
 */
/**
 * FAQ: 如何在C++调用从ArkTS传递过来的function
 */

#include "napi/native_api.h"

// [Start c_plus_call_ark_ts_func_cpp]
...
// [End c_plus_call_ark_ts_func_cpp]
...
extern "C" __attribute__((constructor)) void RegisterCPlusCallArkTSFuncModule(void)
{
