...
// [Start native_cross_module_access_res_cpp]
#include <memory>
#include "string"
...
// [End native_cross_module_access_res_cpp]
...
static napi_module demoModule = {
    ...
    .nm_modname = "nativecrossmoduleaccessres",
    .nm_priv = ((void*)0),
    .reserved = { 0 },
};

extern "C" __attribute__((constructor)) void RegisterNativeCrossModuleAccessResModule(void)
{
