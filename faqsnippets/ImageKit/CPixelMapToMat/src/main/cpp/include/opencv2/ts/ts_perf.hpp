...
#if !(defined(LOGD) || defined(LOGI) || defined(LOGW) || defined())
...
#  define (...) ((void)__android_log_print(ANDROID_LOG_ERROR, PERF_TESTS_LOG_TAG, __VA_ARGS__))
# else
...
#  define (_str, ...) do{printf(_str , ## __VA_ARGS__); printf("\n");fflush(stdout);} while(0)
# endif
#endif
