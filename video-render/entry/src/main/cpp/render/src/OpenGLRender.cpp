...
void OpenGLRender::SetupEglExtensions()
{
...
void OpenGLRender::MakeCurrent(EGLSurface surface) const
{
...
void OpenGLRender::DestroyEglSurface(EGLSurface surface)
{
...
EGLSurface OpenGLRender::CreateEglSurface(EGLNativeWindowType eglNativeWindow, const EGLint *attribList)
{
    if (!IsEglContextReady()) {
        OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_PRINT_DOMAIN, "EglRenderContext",
