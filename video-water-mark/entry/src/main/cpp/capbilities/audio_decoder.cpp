...
int32_t AudioDecoder::Configure(const SampleInfo &sampleInfo)
{
    ...
    OH_AVFormat_SetIntValue(format, OH_MD_KEY_BITRATE, sampleInfo.audioBitRate);
...
int32_t AudioDecoder::FreeOutputBuffer(uint32_t bufferIndex, [[maybe_unused]] bool render)
{
    CHECK_AND_RETURN_RET_LOG(decoder_ != nullptr, AVCODEC_SAMPLE_ERR_ERROR, "Decoder is null");
