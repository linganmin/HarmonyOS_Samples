...
Wallet Kit provides the following functions based on the stage model: activating, previewing, querying, updating, and deleting transportation cards and passes, as well as initializing HUAWEI Wallet.

## Preview

| 1                          | 2                                   | 3                            |
|----------------------------|-------------------------------------|------------------------------|
| ![](screenshots/Index.png) | ![](screenshots/TransitCard_en.png) | ![](screenshots/Pass_en.png) |
...
├─entry/src/main/ets
                   ...
                   ├─common                         // Page utility class.
                   ├─components                     // Page components
                   ├─mainability/MainAbility.ts    // Ability for local startup.  
                   │              
                   └─pages
                       ├─ Index.ets                 // Home page.
                       ├─ wallet
                                ├─ ICCECallBack.ets // ICCE utility class.
                                ├─ Pass.ets         // Pass page.
                                ├─ TransitCard.ets  // Transportation card page.
```
...
The APIs that you need to use for the transportation card function in HUAWEI Wallet are packaged into **@hms.core.payment.walletTransitCard**. An example is as follows:
...
The APIs that you need to use for the pass function in HUAWEI Wallet are packaged into **@hms.core.payment.walletPass**. An example is as follows:
