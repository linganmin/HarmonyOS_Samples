...
export const doGetUserDownloadDirExample: () => string;
export const doScanUserDownloadDirPathExample: () => string;
export const doWriteUserDownloadDirPathExample: () => string;
