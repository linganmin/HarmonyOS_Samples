...
myHapName/src/
|   |--- main/
|        |--- module.json5                            // myHapName模块配置hap类型："type": "feature"
|             |---ets/
|                 |---form/MyForm.ets                 // form处理
|                 |---test/TestRunner.ts              // 测试代码
```
...
echo code/DocsSample/bmsSample/ModuleConfigurationFile01 > .git/info/sparse-checkout
