 ...
 */
#ifndef CAPI_IMAGESPAN_MANAGER_H
#define CAPI_IMAGESPAN_MANAGER_H
...
class TransTool {
public:
    static napi_value CreateImageSpanPage(napi_env env, napi_callback_info info);
    static napi_value CreateImageSpanNode(napi_env env, napi_callback_info info);
    static napi_value RemoveImageSpanNode(napi_env env, napi_callback_info info);
    static napi_value SetImageSpanAttribute(napi_env env, napi_callback_info info);
    static napi_value ResetImageSpanAttribute(napi_env env, napi_callback_info info);
    static napi_value GetImageSpanAttribute(napi_env env, napi_callback_info info);
};
}
