...
#ifndef NDKCREATEUI_LISTITEMGROUP_H
#define NDKCREATEUI_LISTITEMGROUP_H
...
constexpr int32_t HEADER_NUM = 3;
constexpr int32_t TEXT_NUM = 5;
constexpr int32_t HEADER_FONTSIZE = 16;
constexpr int32_t HEADER_HEIGHT = 50;
...
#endif // NDKCREATEUI_LISTITEMGROUP_H
