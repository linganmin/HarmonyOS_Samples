...
void ArkUIListItemNode::SetSwiperAction(std::shared_ptr<ArkUINode> node)
{
    swipeContent_ = node;
...
std::shared_ptr<ArkUINode> ArkUIListItemNode::GetSwipeContent() const { return swipeContent_; }
} // namespace NativeModule