...
void ArkUITextNode::SetFontSize(float fontSize)
{
    assert(handle_);
...
void ArkUITextNode::SetFontColor(uint32_t color)
{
    assert(handle_);
...
void ArkUITextNode::SetTextContent(const std::string &content)
{
    assert(handle_);
...
void ArkUITextNode::SetTextAlign(ArkUI_TextAlignment align)
{
    assert(handle_);
