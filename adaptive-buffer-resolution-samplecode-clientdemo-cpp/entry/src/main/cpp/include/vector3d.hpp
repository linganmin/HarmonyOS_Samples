...
#include <graphics_game_sdk/abr_base.h>
...
public:
    ...
    [[maybe_unused]] constexpr INLINE Vector3D(const ABR_Vector3 &v3) noexcept : x_(v3.x), y_(v3.y), z_(v3.z) {}
    ...
    [[maybe_unused]] Vector3D &operator *= (Vector3D const & v);
    [[maybe_unused]] ABR_Vector3 operator () (Vector3D const & v);
    [[maybe_unused]] operator ABR_Vector3() const;
