...
public:
    ...
    [[nodiscard]] bool InitDisplay() noexcept;
    [[nodiscard]] bool CreateContext() noexcept;
    [[maybe_unused]] void ConfigureProperties() noexcept;
    ...
    [[maybe_unused]] void UpdateTextureUniform(GLuint program, char const *uniformName, GLuint index = 0) const
        noexcept;
...
#define CheckOpenGLError() AdaptiveBufferResolution::Renderer::CheckGLError(__FILE__, __LINE__)
} // namespace AdaptiveBufferResolution
