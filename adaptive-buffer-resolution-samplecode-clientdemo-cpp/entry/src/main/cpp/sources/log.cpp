...
namespace {
constexpr unsigned int ADAPTIVEBUFFERRESOLUTION_DOMAIN = 0xD005810;
...
void Log::Report(Priority prio, const char *format, ...) noexcept
{
    ...
    OH_LOG_Print(LOG_APP, cases[static_cast<size_t>(prio)], ADAPTIVEBUFFERRESOLUTION_DOMAIN, "AdaptiveBufferResolution",
        "%{public}s", str);
}
} // namespace AdaptiveBufferResolution
