...
#define ADAPTIVEBUFFERRESOLUTION_BIND(slot, count, field)                                            \
    ...
    ADAPTIVEBUFFERRESOLUTION_BIND(VERTICES, 3, vertex_);
    ADAPTIVEBUFFERRESOLUTION_BIND(UVS, 2, uv_);
    ADAPTIVEBUFFERRESOLUTION_BIND(NORMALS, 3, normal_);
    ADAPTIVEBUFFERRESOLUTION_BIND(TANGENTS, 3, tangent_);
    ADAPTIVEBUFFERRESOLUTION_BIND(BITANGENTS, 3, bitangent_);

#undef ADAPTIVEBUFFERRESOLUTION_BIND
