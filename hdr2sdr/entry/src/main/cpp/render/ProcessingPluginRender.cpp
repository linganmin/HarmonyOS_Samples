...
void OnSurfaceCreatedCB(OH_NativeXComponent *component, void *window) {
    ...
    if ((xSize == OH_NATIVEXCOMPONENT_RESULT_SUCCESS) && (id == "srcPlayer")) {
        ...
        OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, LOG_TAG,
                     "OnSurfaceCreatedCB create windowOut: w:%{public}ld h:%{public}ld", width, height);
    }
...
PluginRender::PluginRender(std::string &id) { this->id_ = id; }
...
void PluginRender::OnSurfaceChanged(OH_NativeXComponent *component, void *window) {
    ...
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, LOG_TAG,
                 "OnSurfaceChanged offsetX:%{public}lf, "
                 "offsetY:%{public}lf",
                 offsetX, offsetY);
}
...
void PluginRender::OnTouchEvent(OH_NativeXComponent *component, void *window) {
    ...
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, LOG_TAG,
                 "OnTouchEvent toolType:%{public}d, "
                 "tiltX:%{public}lf, tiltY:%{public}lf",
