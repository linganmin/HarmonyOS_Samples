...
export default class Constants {
  // N-Body procedure Number of simulation time steps
  public static readonly TIME_STEPS_TASK_POOL: number = 500000;
  public static readonly TIME_STEPS_WORKER: number = 5000000;
  // Mathematical π
  public static readonly PI: number = Math.PI;
  // Solar mass coefficient
  ...
  // Jupiter's position, velocity, and mass relative to the Sun
  ...
  // Saturn's position, velocity, and mass
  ...
  // Uranus's position, velocity, and mass
  ...
  // Neptune's position, velocity, and mass
